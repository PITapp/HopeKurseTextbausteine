/*
  ...
  Modify datenschutz.component.ts instead.
*/
...
export class DatenschutzGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.dbHopeKurseTextbausteine.getInfotexteHtmls(`Code eq 'DatenschutzWeb'`, null, null, null, null, null, null, null)
    .subscribe((result: any) => {
      this.datenschutzHtml = result.value[0].Inhalt;
    }, (result: any) => {
