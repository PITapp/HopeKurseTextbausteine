/*
  ...
  Modify kurse-themen-neu.component.ts instead.
*/
...
export class KurseThemenNeuGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.dbHopeKurseTextbausteine.createIbsiKurseThemen(null, event)
    .subscribe((result: any) => {
      this.notificationService.notify({ severity: "success", summary: `Thema erfolgreich erstellt`, detail: `` });

      this.dialogRef.close(result);
    }, (result: any) => {
      this.notificationService.notify({ severity: "error", summary: `Thema konnte nicht erstellt werden!`, detail: `` });
    });
  }
