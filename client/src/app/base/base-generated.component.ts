/*
  ...
  Modify base.component.ts instead.
*/
...
export class BaseGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  grid0Add(event: any) {
    this.dialogService.open(AddBaseComponent, { parameters: {}, title: 'Add Base' });
  }
  ...
  grid0RowSelect(event: any) {
    this.dialogService.open(EditBaseComponent, { parameters: {BaseID: event.BaseID}, title: 'Edit Base' });
  }
}
