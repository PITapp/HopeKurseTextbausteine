/*
  ...
  Modify edit-kontakte.component.ts instead.
*/
...
export class EditKontakteGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.dbHopeKurseTextbausteine.getBaseByBaseId(null, this.parameters.BaseID)
    .subscribe((result: any) => {
      this.base = result;

      if (this.base.AnredeID != null) {
              this.dbHopeKurseTextbausteine.getBaseAnredenByAnredeId(null, this.base.AnredeID)
        .subscribe((result: any) => {
  ...
  form0Submit(event: any) {
    this.dbHopeKurseTextbausteine.updateBase(null, this.parameters.BaseID, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
