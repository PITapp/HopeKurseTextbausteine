/*
  ...
  Modify einstellungen-autoren-bearbeiten.component.ts instead.
*/
...
export class EinstellungenAutorenBearbeitenGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    ...
    .subscribe((result: any) => {
      this.ibsitextbausteineautoren = result;
    }, (result: any) => {
  ...
  form0Submit(event: any) {
    ...
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update IbsiTextbausteineAutoren` });
    });
  }
