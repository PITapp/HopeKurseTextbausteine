/*
  ...
  Modify add-benutzer.component.ts instead.
*/
...
export class AddBenutzerGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.dbHopeKurseTextbausteine.createBenutzer(null, Object.assign(event, { BaseID: this.parameters.BaseID }))
