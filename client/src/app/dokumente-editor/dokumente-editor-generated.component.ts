/*
  ...
  Modify dokumente-editor.component.ts instead.
*/
...
export class DokumenteEditorGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  strTextbausteinDokumentHTML: any;
  onDirtyEditor: any;
  parameters: any;
  ...
  load() {
    ...
    .subscribe((result: any) => {
      this.dsoTextbausteineDokumente = result;

      this.strTextbausteinDokumentHTML = result.TextbausteinHTML;
  ...
  buttonSpeichernClick(event: any) {
    this.dsoTextbausteineDokumente.TextbausteinHTML = this.strTextbausteinDokumentHTML
