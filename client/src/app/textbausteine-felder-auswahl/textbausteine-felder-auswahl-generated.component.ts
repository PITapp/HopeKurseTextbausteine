/*
  ...
  Modify textbausteine-felder-auswahl.component.ts instead.
*/
...
export class TextbausteineFelderAuswahlGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  @ViewChild('content1') content1: ContentComponent;
  @ViewChild('form0') form0: TemplateFormComponent;
  @ViewChild('nameFelder') nameFelder: LabelComponent;
  @ViewChild('listboxFelder') listboxFelder: ListBoxComponent;
  ...
  load() {
    this.dbHopeKurseTextbausteine.getIbsiTextbausteineFelders(null, null, null, `Sortierung, Titel`, null, null, null, null)
    .subscribe((result: any) => {
      this.rstFelder = result.value;
    }, (result: any) => {
