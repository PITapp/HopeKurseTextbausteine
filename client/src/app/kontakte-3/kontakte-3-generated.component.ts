/*
  ...
  Modify kontakte-3.component.ts instead.
*/
...
export class Kontakte3Generated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  grid0Add(event: any) {
    this.dialogService.open(AddKontakte3Component, { parameters: {}, title: 'Add Kontakte 3' });
  }

  grid0RowSelect(event: any) {
    this.dialogService.open(EditKontakte3Component, { parameters: {BaseID: event.BaseID}, title: 'Edit Kontakte 3' });
  }
}
