/*
  ...
  Modify infobox-textbausteine-filter-text.component.ts instead.
*/
...
export class InfoboxTextbausteineFilterTextGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
