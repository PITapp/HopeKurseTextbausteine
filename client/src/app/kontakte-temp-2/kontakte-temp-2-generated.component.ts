/*
  ...
  Modify kontakte-temp-2.component.ts instead.
*/
...
export class KontakteTemp2Generated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  grid0Add(event: any) {
    this.dialogService.open(AddKontakteComponent, { parameters: {}, title: 'Add Kontakte' });
  }

  grid0RowSelect(event: any) {
    this.dialogService.open(EditKontakteComponent, { parameters: {BaseID: event.BaseID}, title: 'Edit Kontakte' });
  }
}
