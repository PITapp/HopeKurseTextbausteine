/*
  ...
  Modify einstellungen-infotexte-editor-kopie-1.component.ts instead.
*/
...
export class EinstellungenInfotexteEditorKopie1Generated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  @ViewChild('content1') content1: ContentComponent;
  @ViewChild('form0') form0: TemplateFormComponent;
  @ViewChild('panel6') panel6: PanelComponent;
  @ViewChild('htmlEditorInfotexte2') htmlEditorInfotexte2: HtmlComponent;
  ...
  load() {
    ...
    this.dbHopeKurseTextbausteine.getInfotexteHtmlByInfotextId(null, this.parameters.InfotextID)
  ...
  form0Submit(event: any) {
    ...
    this.dbHopeKurseTextbausteine.updateInfotexteHtml(null, this.parameters.InfotextID, this.dsoInfotexteHTML)
    .subscribe((result: any) => {
