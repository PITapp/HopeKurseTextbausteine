/*
  ...
  Modify benutzer-neu-rolle.component.ts instead.
*/
...
export class BenutzerNeuRolleGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    ...
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Rolle kann nicht erstellt werden!`, detail: `${result.error.message}` });
    });
  }
