/*
  ...
  Modify kontakte-5.component.ts instead.
*/
...
export class Kontakte5Generated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  grid0Add(event: any) {
    this.dialogService.open(AddKontakte5Component, { parameters: {}, title: 'Add Kontakte 5' });
  }

  grid0RowSelect(event: any) {
    this.dialogService.open(EditKontakte5Component, { parameters: {BaseID: event.BaseID}, title: 'Edit Kontakte 5' });
  }
}
