/*
  ...
  Modify textbausteine-neu.component.ts instead.
*/
...
export class TextbausteineNeuGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.dbHopeKurseTextbausteine.createIbsiTextbausteine(null, event)
    .subscribe((result: any) => {
      this.notificationService.notify({ severity: "success", summary: ``, detail: `Textbaustein erstellt` });

      this.dialogRef.close(result);
    }, (result: any) => {
      this.notificationService.notify({ severity: "error", summary: ``, detail: `Textbaustein konnte nicht erstellt werden!` });
    });
  }
